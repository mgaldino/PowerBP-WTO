...
## Correção documental posterior ao gate

Em 19/09/2026, B identificou referência residual a quatro notas/bundle v1 em `synthesis.scope_conditions[0]`. CONFIRMED por confronto com cinco payloads e identidade v2. O JSON anterior `15813af5fe6efbd53a840bebe7c072a5f6ec3b2738786743f2a4ee831ca92e2c` foi preservado em `snapshots/15813af5/argument_contract.json`; os demais documentos também foram copiados. O campo agora declara cinco notas e o hash v2 completo. Revisão editorial restrita, sem mudar fonte, claims, domínios ou conclusão interpretativa. O novo JSON é validado antes da entrega.
