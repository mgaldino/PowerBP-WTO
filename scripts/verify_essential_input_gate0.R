...
cat(
  paste0(
    ...
    "no derivation node is topologically ready. Goal 4 still requires the author's explicit ",
    "post-freeze approval; Goal 5, beta=1 extensions, and manuscript migration remain unauthorized. ",
