...
# Conditional weak-state entry/nesting check under the pi_H = 0 C-or-R
...
compute_entry_nesting_C_or_R <- function(N, r, alpha, beta) {
...
objects <- do.call(compute_entry_nesting_C_or_R, params)

cat("C-or-R entry/nesting check under pi_H = 0\n")
...
cat("\nEntry/nesting C-or-R check passed for the OPEC calibration.\n")
